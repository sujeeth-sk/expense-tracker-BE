...
const TABLE_NAME1 = 'expenses'
const TABLE_NAME2 = 'users'
const TABLE_NAME3 = 'budgets'
...
async function checkOrCreateTable() {
    try {
        dbClient.send(new DescribeTableCommand({TableName: TABLE_NAME1}))
        console.log("table exitst")
    } catch (error) {
